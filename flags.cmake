...
SET(CMAKE_EXE_LINKER_FLAGS_DEBUG " \
    ...
    ${FPU} \
    ${SPECS} \
    -T\"${ProjDirPath}/MIMX8ML8/gcc/MIMX8ML8xxxxx_cm7_ram.ld\" -static \
")
...
SET(CMAKE_EXE_LINKER_FLAGS_DDR_DEBUG " \
    ...
    ${FPU} \
    ${SPECS} \
    -T\"${ProjDirPath}/MIMX8ML8/gcc/MIMX8ML8xxxxx_cm7_ddr_ram.ld\" -static \
")
...
SET(CMAKE_EXE_LINKER_FLAGS_FLASH_DEBUG " \
    ...
    ${FPU} \
    ${SPECS} \
    -T\"${ProjDirPath}/MIMX8ML8/gcc/MIMX8ML8xxxxx_cm7_flash.ld\" -static \
")
